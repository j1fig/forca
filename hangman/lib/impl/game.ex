defmodule Hangman.Impl.Game do
  ...
  def make_move(game, guess) do
    accept_guess(game, guess, MapSet.member?(game.used, guess), String.match?(guess, ~r/[^\x00-\x7F]/))
    |> return_with_tally
  end
  ...
  defp accept_guess(game, _guess, _already_used, _invalid_guess = true) do
    %{game | game_state: :invalid_guess}
  end

  defp accept_guess(game, _guess, _already_used = true, _invalid_guess) do
    %{game | game_state: :already_used}
  end

  defp accept_guess(game, guess, _already_used, _invalid_guess) do
