defmodule TextClient.Impl.Player do
  ...
  # :initializing | :good_guess | :bad_guess | :already_used | :invalid_guess
  ...
  def current_word(tally) do
    [
      ...
      IO.ANSI.format([:green, "   (turns left: ", :cyan, tally.turns_left |> to_string]),
      IO.ANSI.format([:green, ", used: ", :yellow, tally.used |> Enum.join(","), :green, ")"]),
    ]
  end
